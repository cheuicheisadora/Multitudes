...
// Vídeos reais de análise política brasileira (fallback quando API key não configurada)
const FALLBACK_VIDEOS: YTVideo[] = [
  {
    // Roda Viva — entrevista política clássica
    id:          'ZRTNHDd0gL8',
  ...
  {
    // Debate político — Câmara dos Deputados
    id:          'xvFZjo5PgG0',
